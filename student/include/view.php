                                ...
                                <div class="tab-content">
                                  <div class="active tab-pane" id="payfee">
                                   <form method="POST" id="PayFeeForm">
                                        ...
                                        <div class="col-12 table-responsive">
                                         ...
                                         <h5>Pay Remaining<b><a href="javascript:void(0);"> Fee</a></b></h5>
                                          ...
                                          <table class="table table-bordered table-sm">
                                            ...
                                            <input id="total_amount" name="total_amount" min="0" max="<?php echo $totalRemainings ?>" type="number" class="form-control" readonly></div>                                                 
                                              ...
                                              <td class="text-bold">
                                                 <div class="input-group">
                                                  <div class="input-group-prepend">
                                                   ...
                                                   <!--<input id="remaining_amount" name="remaining_amount" min="0" value="0<?php //echo $totalRemainings ?>" type="number" style="font-weight: 900;color: #dc3545;" class="form-control" readonly>-->
													...
													<form id="payment_form" method="post"  action="easebuzz/easebuzz.php?api_name=initiate_payment">
														...
														<div class="form-row">
														   ...
														   <div class="form-group col-md-6">
																...
																<!--<input class="form-control" id="amount"  name="amount" value="<?php //echo $_SESSION["remaining_amount"] ?>" readonly>-->
                                    ...
                                    <script>
                                      window.onscroll = function() {completeCalculation()};
		   ...
		   <form action="exam_confirm" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
		      <div class="col-4">
                ...
                <input type="file" id="fileSign" 
               onchange="Filevalidation()"  name="candidate_signature" class="form-control" required>	
                    <script>
                        Filevalidation = () => {
